...
var clock$ = (0, _rxjs.interval)(1000).pipe((0, _operators.map)(function () {
  var date = new Date();
  return {
    sec: date.getSeconds(),
    min: date.getMinutes(),
...
var hourSub = clock$.subscribe(function (_ref) {
  var hour = _ref.hour,
      min = _ref.min;
  var hourDegrees = hour / 12 * 360 + min / 60 * 30 + 90;
  hourHand.style.transform = "rotate(".concat(hourDegrees, "deg)");
});
var minuteSub = clock$.subscribe(function (_ref2) {
  var sec = _ref2.sec,
      min = _ref2.min;
  var minsDegrees = min / 60 * 360 + sec / 60 * 6 + 90;
  minuteHand.style.transform = "rotate(".concat(minsDegrees, "deg)");
});
var secondSub = clock$.subscribe(function (_ref3) {
  var sec = _ref3.sec;
  var secondsDegrees = sec / 60 * 360 + 90;
